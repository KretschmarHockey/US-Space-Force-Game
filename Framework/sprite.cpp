...
void
Sprite::DrawFlippableSprite(BackBuffer& backbuffer, Direction direction)
{
	backbuffer.DrawFlippableSprite(*this, direction);
}

void
Sprite::DrawParticle(BackBuffer& backBuffer, int x, int y, SDL_Rect* clip)
{
	backBuffer.DrawParticleSprite(*this, x, y, clip);
}
